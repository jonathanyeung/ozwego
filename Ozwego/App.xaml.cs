...
namespace Ozwego
{
    ...
    {
        public static ServerProxy ServerProxy = ServerProxy.GetInstance();

        public static BuddyList BuddyList = BuddyList.GetInstance();
        ...
        //
        public static MainPageViewModel MainPageViewModel = MainPageViewModel.GetInstance();
